...
beforeEach(() => {
  ...
  api.receivePayment.mockResolvedValue({ id: "student-1", enrollmentId: "enrollment-1", fullName: "Deniz Arslan", email: "deniz@example.com", phoneMasked: "•••", enrollmentStatus: "ACTIVE", registrationFee: 12500, paymentPlan: "CASH", installmentCount: null, firstPaymentDate: null, paymentStatus: "COMPLETED", expectedPaymentDate: "2026-08-20", note: null, payments: [{ id: "payment-1", installmentNumber: 1, installmentTotal: 1, amount: 12500, dueDate: "2026-08-20", status: "COMPLETED", paidAt: "2026-08-08", paymentMethod: "CASH", version: 1 }], version: 1 });
